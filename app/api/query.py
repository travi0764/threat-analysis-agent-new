...
from app.storage.models import IndicatorType, SourceType, RiskLevel
...
async def list_indicators(
    ...
    indicator_type: Optional[IndicatorType] = Query(default=None, description="Filter by type"),
    source_type: Optional[SourceType] = Query(default=None, description="Filter by source"),
    ...
    try:
        ...
        for indicator in indicators:
            ...
            result.append(IndicatorDetailResponse(
                id=indicator.id,
                ...
                last_seen=indicator.last_seen.isoformat() if indicator.last_seen else indicator.created_at.isoformat(),
