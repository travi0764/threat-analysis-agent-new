...
from app.storage.repository import IndicatorRepository, ClassificationRepository
...
async def classify_indicator(
    indicator_id: int,
    force: bool = Query(default=False, description="Force reclassification if already classified"),
    ...
    try:
        ...
        if existing and not force:
            logger.info(f"Indicator {indicator_id} already classified, returning existing")
